        ...
        <div class="page-header bg-white shadow-sm rounded p-4 mb-6 d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-1 text-primary d-flex align-items-center">
                    <i class="bx bx-book-content me-2"></i> Data Antri
                </h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">Data Antri</li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="/admin/antrian">Data Antrian</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($antrian as $data)
                                    <tr>
                                        ...
                                        <td class="py-2 "><span class="badge bg-secondary">{{ $data->status }}</span></td>
