        ...
        <div class="page-header bg-white shadow-sm rounded p-4 mb-6 d-flex justify-content-between align-items-center">
            <div>
                <h5 class="mb-1 text-primary d-flex align-items-center">
                    <i class="bx bx-book-content me-2"></i> Data Selesai
                </h5>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">Data Selesai</li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="/admin/antrian">Data Selesai</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-primary fw-bold mb-0 d-flex align-items-center">
                            <i class="bx bx-list-ul fs-3 me-2"></i> List Selesai
                        </h4>
                        ...
                        <table id="dataTable" class="table table-bordered table-hover table-striped">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="fs-6 text-center py-2">Pembayaran</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $no = 1; ?>
                                @foreach ($antrian as $data)
                                    <tr>
                                        ...
                                        <td class="py-2 text-wrap">{{ $data->waktu_kedatangan ?? '-' }}</td>
                                        <td class="py-2 text-wrap">{{ $data->keterangan ?? '-' }}</td>
                                        <td class="py-2 text-wrap text-center"><span class="badge bg-success">{{ $data->metode_pembayaran }}</span></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
