            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="/admin/jenis">Jenis Therapi</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-primary fw-bold mb-0 d-flex align-items-center">
                            <i class="bx bx-list-ul fs-3 me-2"></i> List Data Jenis
                        </h4>
                        @if (Auth::user()->level == 1)
                            <a href="/admin/jenis/add" class="btn btn-primary btn-sm d-flex align-items-center">
                        ...
                        <table id="dataTable" class="table table-bordered table-hover table-striped">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="fs-6 text-center py-2">Nama Jenis Terapi</th>
                                    @if (Auth::user()->level == 1)
                            ...
                            <tbody>
                                ...
                                @foreach ($jenis as $data)
                                    <tr>
                                        ...
                                        <td class="py-2">{{ $data->jenis }}</td>
                                        @if (Auth::user()->level == 1)
                                            <td class="text-center py-2">
                                                <a href="/admin/jenis/edit/{{ $data->id }}"
