      ...
      <div>
         ...
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
               ...
               <li class="breadcrumb-item active" aria-current="page">Tambah Jenis Therapi</li>
            </ol>
         </nav>
      </div>
   </div>
         ...
         <div class="card p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
               <h4 class="text-primary fw-bold mb-0 d-flex align-items-center">
                  <i class="bx bx-add-to-queue me-2"></i> Tambah Data Jenis
               </h4>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="form-group">
                     ...
                     <input type="text" autofocus name="jenis" required class="form-control" placeholder="Masukkan Nama Jenis .....">
                  </div>
               </div>
            </div>
