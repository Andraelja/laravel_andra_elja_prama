            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="/admin/jenis">Metode Pembayaran</a>
                        </li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-primary fw-bold mb-0 d-flex align-items-center">
                            <i class="bx bx-list-ul fs-3 me-2"></i> List Data Metode Pembayaran
                        </h4>
                        @if (Auth::user()->level == 1)
                            <a href="/admin/metode_pembayaran/add" class="btn btn-primary btn-sm d-flex align-items-center">
                        ...
                        <table id="dataTable" class="table table-bordered table-hover table-striped">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="fs-6 text-center py-2">Nama</th>
                                    <th class="fs-6 text-center py-2">Nomor Rekening</th>
                                    <th class="fs-6 text-center py-2">Atas Nama</th>
                                    @if (Auth::user()->level == 1)
                            ...
                            <tbody>
                                ...
                                @foreach ($metode_pembayaran as $data)
                                    <tr>
                                        ...
                                        <td class="py-2 text-center">{{ $data->nama }}</td>
                                        <td class="py-2 text-center">{{ $data->nomor_rekening }}</td>
                                        <td class="py-2 text-center">{{ $data->atas_nama }}</td>
                                        @if (Auth::user()->level == 1)
                                            <td class="text-center py-2">
                                                <a href="/admin/metode_pembayaran/edit/{{ $data->id }}"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="mt-5">Nomor Rekening</label>
                            <input class="form-control" value="{{ $data->nomor_rekening }}" readonly
                                style="background-color: white;pointer-events: none;">
                        </div>
                        <div class="form-group">
                            <label class="mt-5">Atas Nama</label>
                            <input class="form-control" value="{{ $data->atas_nama }}" readonly
                                style="background-color: white;pointer-events: none;">
                        </div>
                        <div class="row mt-6">
                            <div class="col-md-6">
                                <a href="/admin/metode_pembayaran/delete/{{ $data->id }}"
