            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="/admin/metode_pembayaran">Metode Pembayran</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah Metode Pembayran</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-primary fw-bold mb-0 d-flex align-items-center">
                            <i class="bx bx-add-to-queue me-2"></i> Tambah Data Metode Pembayaran
                        </h4>
                    ...
                    <hr class="mt-0">
                    <form action="/admin/metode_pembayaran/create" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-sm mb-1">Nomor Rekening</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="text-sm mt-5">Atas Nama</label>
