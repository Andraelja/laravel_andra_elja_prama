            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="/admin/surat/surat_sakit">Surat
                                Sakit</a></li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-primary fw-bold mb-0 d-flex align-items-center">
                            <i class="bx bx-list-ul fs-3 me-2"></i> List Data Surat Sakit
                        </h4>
                        <a href="/admin/surat/surat_sakit/add" class="btn btn-primary btn-sm d-flex align-items-center">
                        ...
                        <table id="dataTable" class="table table-bordered table-hover table-striped">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="fs-6 text-center py-2 align-middle text-wrap">Nama Lengkap</th>
                                    <th class="fs-6 text-center py-2 align-middle text-wrap">Dokter Yang Menangani</th>
                                    <th class="fs-6 text-center py-2 align-middle">Diagnosa</th>
                                    <th class="fs-6 text-center py-2 align-middle text-wrap">Waktu Istirahat</th>
                                    <th class="fs-6 text-center py-2 align-middle" width="5%">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($surat_sakit as $data)
                                    <tr>
                                        ...
                                        <td class="text-start text-break text-wrap py-2 fs-6">{{ $data->waktu_istirahat }}
                                            Hari
                                        </td>
                                        <td class="text-center py-2">
                                            <form action="{{ url('admin/surat/surat_sakit/cetak/' . $data->id_pasien) }}"
                                            ...
                                            <a href="{{ url('admin/surat/surat_sakit/edit/' . $data->id) }}"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-6">
                            <div class="col-md-6">
                                <a href="{{ url('admin/surat/surat_sakit/delete/' . $data->id) }}"
